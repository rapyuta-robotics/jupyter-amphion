...
LONG_DESCRIPTION = 'Jupyter Widget for Amphion'
...
version_ns = {}
with open(os.path.join(here, 'jupyter_amphion', '_version.py')) as f:
...
setup_args = {
    ...
    'url': 'https://github.com/rapyuta-robotics/jupyter-amphion',
    'keywords': [
        'ipython',
        'jupyter',
        'widgets',
